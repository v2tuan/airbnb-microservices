...
export default async function SearchPage({ searchParams }: SearchPageProps) {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="mx-auto grid w-full max-w-[1760px] gap-8 px-4 py-7 sm:px-8 lg:grid-cols-[minmax(0,1fr)_minmax(360px,42vw)] xl:px-10">
        <section>
          <div className="mb-6 flex flex-col gap-2">
            <p className="text-sm text-neutral-500">
              {visibleListings.length} stays · {priceLabel}
                  ...
                  >
                    <article className="space-y-3">
                      <div className="relative aspect-square overflow-hidden rounded-xl bg-neutral-100">
                        ...
                        />
                        <span className="absolute right-3 top-3 flex size-9 items-center justify-center rounded-full bg-white/90 text-neutral-900 shadow-sm">
                          <Heart className="size-5" />
                        </span>
                        {listing.instantBook ? (
                          <span className="absolute left-3 top-3 rounded-full bg-white px-3 py-1 text-xs font-bold text-neutral-950 shadow-sm">
                            Instant Book
                          </span>
                        ) : null}
                      </div>
                      ...
                      <div className="space-y-1">
                        <div className="flex items-start justify-between gap-3">
                          <h2 className="line-clamp-1 text-base font-semibold text-neutral-950">
                            {listing.city}, {listing.country}
                          </h2>
                          <span className="inline-flex items-center gap-1 text-sm text-neutral-950">
                            <Star className="size-4 fill-neutral-950" />
        ...
        <aside className="hidden lg:block">
          <div className="sticky top-44 h-[calc(100vh-190px)] overflow-hidden rounded-xl border border-neutral-200 bg-neutral-100 shadow-sm">
