...
import {BookingFilterType, BookingTripsResponse} from "@/types/booking.type";
...
export default function TripsPage() {
        ...
        async function fetchBookings() {
            try {
                ...
                const response = await getMyBookings(
                    token,
                    activeTab as BookingFilterType
                );
    ...
    const counts = useMemo(() => {
        return {
            UPCOMING:
                activeTab === "UPCOMING" ? trips.length : 0,

            COMPLETED:
                activeTab === "COMPLETED" ? trips.length : 0,

            CANCELLED:
                activeTab === "CANCELLED" ? trips.length : 0,
        };
    }, [activeTab, trips]);
